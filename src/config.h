...
#define CPU_MAP_ESP32_PLUS // these are defined in cpu_map.h
...
#define NAMESPACE "GRBL ESP32 Plus"
...
#define REPORT_OVR_REFRESH_BUSY_COUNT 100  // (1-255)
#define REPORT_OVR_REFRESH_IDLE_COUNT 50  // (1-255) Must be less than or equal to the busy count
#define REPORT_WCO_REFRESH_BUSY_COUNT 100  // (2-255)
#define REPORT_WCO_REFRESH_IDLE_COUNT 25  // (2-255) Must be less than or equal to the busy count
